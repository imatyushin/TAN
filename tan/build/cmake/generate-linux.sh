...
cmake .. -DCMAKE_PREFIX_PATH="/opt/Qt5.6.3/5.6.3/gcc_64" -DOpenCL_INCLUDE_DIR="../../../../thirdparty/OpenCL-Headers" -DOpenCL_LIBRARY="/opt/rocm/opencl/lib/x86_64/libOpenCL.so" -DPortAudio_DIR="../../../../../thirdparty/portaudio"
cd ..
